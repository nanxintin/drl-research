...
def create_network(session, available_actions_count):
    ...
    conv2 = tf.contrib.layers.convolution2d(conv1, num_outputs=32, kernel_size=[3, 3], stride=[2, 2],
                                            ...
                                            weights_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            biases_initializer=tf.constant_initializer(0.1))
    conv3 = tf.contrib.layers.convolution2d(conv2, num_outputs=64, kernel_size=[4, 6], stride=[1, 1],
                                            activation_fn=tf.nn.relu,
                                            weights_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            biases_initializer=tf.constant_initializer(0.1))
    conv4 = tf.contrib.layers.convolution2d(conv3, num_outputs=available_actions_count, kernel_size=[1, 1], stride=[1, 1],
                                            weights_initializer=tf.contrib.layers.xavier_initializer_conv2d(),
                                            biases_initializer=tf.constant_initializer(0.1))

    q = tf.contrib.layers.flatten(conv4)
